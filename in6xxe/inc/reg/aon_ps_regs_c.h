...
#define AON_PS_REGS_OFF_DELAY_1_CTRL_DEFAULT                                         0x7080004
...
#define AON_PS_REGS_MISC_BYPASS_0_CTRL_DEFAULT                                       0x1A502
...
#define AON_PS_REGS_MISC_BYPASS_0_CTRL_PWR_PD_DOO_EN_VAL                             (Bit16)
#define AON_PS_REGS_MISC_BYPASS_0_CTRL_PWR_PD_DOO_EN_EN                              (Bit17)
...
#define AON_PS_REGS_REQUEST_WITH_SOFT_CLR                                            (AON_PS_REGS_BASE + 0x238)
#define AON_PS_REGS_REQUEST_WITH_SOFT_CLR_DEFAULT                                    0x0
#define AON_PS_REGS_REQUEST_WITH_SOFT_CLR_GPIO_WAKEUP                                (Bit0)
#define AON_PS_REGS_REQUEST_WITH_SOFT_CLR_AON_ST_WAKEUP                              (Bit1)
#define AON_PS_REGS_REQUEST_WITH_SOFT_CLR_BLE_ST_WAKEUP                              (Bit2)
#define AON_PS_REGS_REQUEST_WITH_SOFT_CLR_BO_OUT_WAKEUP                              (Bit3)
#define AON_PS_REGS_REQUEST_WITH_SOFT_CLR_MSIO_WAKEUP                                (Bit4)
#define AON_PS_REGS_REQUEST_WITH_SOFT_CLR_PD_DOO_SLEEP                               (Bit8)
#define AON_PS_REGS_REQUEST_WITH_SOFT_CLR_CTL_REQUEST_CLR                            (Bit31)
