...
#define RFTRX_REG_CPLL_REG_1TO4_DEFAULT                                                      0xC4C4290
...
#define RFTRX_REG_CPLL_REG_1TO3_1M_DEFAULT                                                   0x4C48D0
...
#define RFTRX_REG_MPLL_2P4_REG_5TO8_DEFAULT                                                  0x1B841790
...
#define RFTRX_REG_MPLL_2P4_REG_9TO12_DEFAULT                                                 0x800EFABA
...
#define RFTRX_REG_MPLL_2P4_REG_13TO14_DEFAULT                                                0x5A84
...
#define RFTRX_REG_MPLL_REG_9_2M_DEFAULT                                                      0x44BE
...
#define RFTRX_REG_RX_2P4_REG_1TO4_DEFAULT                                                    0x30B7FF24
...
#define RFTRX_REG_RX_2P4_REG_5TO8_DEFAULT                                                    0xC0C8CCC
...
#define RFTRX_REG_RX_REG_3_2M_DEFAULT                                                        0x97
...
#define RFTRX_REG_TX_REG_DEFAULT                                                             0x7F0718
...
#define RFTRX_REG_TX_REG1_IPMAC                                                              (RFTRX_REG_BASE + 0xd4)
#define RFTRX_REG_TX_REG1_IPMAC_DEFAULT                                                      0x181818
#define RFTRX_REG_TX_REG1_IPMAC_CTL_TX_REG_TX_2P4_REG1_SEL1                                  (Bit0+Bit1+Bit2+Bit3+Bit4+Bit5+Bit6+Bit7)
#define RFTRX_REG_TX_REG1_IPMAC_CTL_TX_REG_TX_2P4_REG1_SEL1_MASK                             (Bit7+Bit6+Bit5+Bit4+Bit3+Bit2+Bit1+Bit0)
#define RFTRX_REG_TX_REG1_IPMAC_CTL_TX_REG_TX_2P4_REG1_SEL1_SHIFT                            (0)
#define RFTRX_REG_TX_REG1_IPMAC_CTL_TX_REG_TX_2P4_REG1_SEL2                                  (Bit8+Bit9+Bit10+Bit11+Bit12+Bit13+Bit14+Bit15)
#define RFTRX_REG_TX_REG1_IPMAC_CTL_TX_REG_TX_2P4_REG1_SEL2_MASK                             (Bit7+Bit6+Bit5+Bit4+Bit3+Bit2+Bit1+Bit0)
#define RFTRX_REG_TX_REG1_IPMAC_CTL_TX_REG_TX_2P4_REG1_SEL2_SHIFT                            (8)
#define RFTRX_REG_TX_REG1_IPMAC_CTL_TX_REG_TX_2P4_REG1_SEL3                                  (Bit16+Bit17+Bit18+Bit19+Bit20+Bit21+Bit22+Bit23)
#define RFTRX_REG_TX_REG1_IPMAC_CTL_TX_REG_TX_2P4_REG1_SEL3_MASK                             (Bit7+Bit6+Bit5+Bit4+Bit3+Bit2+Bit1+Bit0)
#define RFTRX_REG_TX_REG1_IPMAC_CTL_TX_REG_TX_2P4_REG1_SEL3_SHIFT                            (16)
#define RFTRX_REG_TX_REG1_IPMAC_CTL_TX_PWR_IPMAC_CS_ADDR_SEL_EN                              (Bit24)


#define RFTRX_REG_TX_5P8_REG1_IPMAC                                                          (RFTRX_REG_BASE + 0xd8)
#define RFTRX_REG_TX_5P8_REG1_IPMAC_DEFAULT                                                  0x181818
#define RFTRX_REG_TX_5P8_REG1_IPMAC_CTL_TX_REG_TX_5P8_REG1_SEL1                              (Bit0+Bit1+Bit2+Bit3+Bit4+Bit5+Bit6+Bit7)
#define RFTRX_REG_TX_5P8_REG1_IPMAC_CTL_TX_REG_TX_5P8_REG1_SEL1_MASK                         (Bit7+Bit6+Bit5+Bit4+Bit3+Bit2+Bit1+Bit0)
#define RFTRX_REG_TX_5P8_REG1_IPMAC_CTL_TX_REG_TX_5P8_REG1_SEL1_SHIFT                        (0)
#define RFTRX_REG_TX_5P8_REG1_IPMAC_CTL_TX_REG_TX_5P8_REG1_SEL2                              (Bit8+Bit9+Bit10+Bit11+Bit12+Bit13+Bit14+Bit15)
#define RFTRX_REG_TX_5P8_REG1_IPMAC_CTL_TX_REG_TX_5P8_REG1_SEL2_MASK                         (Bit7+Bit6+Bit5+Bit4+Bit3+Bit2+Bit1+Bit0)
#define RFTRX_REG_TX_5P8_REG1_IPMAC_CTL_TX_REG_TX_5P8_REG1_SEL2_SHIFT                        (8)
#define RFTRX_REG_TX_5P8_REG1_IPMAC_CTL_TX_REG_TX_5P8_REG1_SEL3                              (Bit16+Bit17+Bit18+Bit19+Bit20+Bit21+Bit22+Bit23)
#define RFTRX_REG_TX_5P8_REG1_IPMAC_CTL_TX_REG_TX_5P8_REG1_SEL3_MASK                         (Bit7+Bit6+Bit5+Bit4+Bit3+Bit2+Bit1+Bit0)
#define RFTRX_REG_TX_5P8_REG1_IPMAC_CTL_TX_REG_TX_5P8_REG1_SEL3_SHIFT                        (16)
...
#define RFTRX_REG_SDADC_REG_5TO8_1M_DEFAULT                                                  0x4080F0F0
...
#define RFTRX_REG_SDADC_REG_5TO8_2M_DEFAULT                                                  0x8307070
...
#define RFTRX_REG_SDADC_REG_9TO12_1M_DEFAULT                                                 0xF684A484
...
#define RFTRX_REG_SDADC_REG_9TO12_2M_DEFAULT                                                 0xB2848484
...
#define RFTRX_REG_AGC_REG_DEFAULT                                                            0x870B0B
...
#define RFTRX_REG_PLL_TRIG_MISC_CTRL_CTL_MPLL_2P4_REG_1TO4_LATCH                             (Bit8)
...
#define RFTRX_REG_TX_SCALE_HP_LP_DEFAULT                                                     0xB3815C83
...
#define RFTRX_REG_TX_SCALE_HP_LP_CTL_TX_SCALE_HP_1M                                          (Bit8+Bit9+Bit10+Bit11+Bit12+Bit13+Bit14+Bit15)
#define RFTRX_REG_TX_SCALE_HP_LP_CTL_TX_SCALE_HP_1M_MASK                                     (Bit7+Bit6+Bit5+Bit4+Bit3+Bit2+Bit1+Bit0)
#define RFTRX_REG_TX_SCALE_HP_LP_CTL_TX_SCALE_HP_1M_SHIFT                                    (8)
...
#define RFTRX_REG_TX_SCALE_HP_LP_CTL_TX_SCALE_HP_2M                                          (Bit24+Bit25+Bit26+Bit27+Bit28+Bit29+Bit30+Bit31)
#define RFTRX_REG_TX_SCALE_HP_LP_CTL_TX_SCALE_HP_2M_MASK                                     (Bit7+Bit6+Bit5+Bit4+Bit3+Bit2+Bit1+Bit0)
#define RFTRX_REG_TX_SCALE_HP_LP_CTL_TX_SCALE_HP_2M_SHIFT                                    (24)


#define RFTRX_REG_TRX_PLL_TRIG_MUX_CTRL                                                      (RFTRX_REG_BASE + 0x1ec)
#define RFTRX_REG_TRX_PLL_TRIG_MUX_CTRL_DEFAULT                                              0xD111
...
#define RFTRX_REG_TRX_PLL_TRIG_MUX_CTRL_CTL_USE_MDM_PA_GAIN                                  (Bit13)
#define RFTRX_REG_TRX_PLL_TRIG_MUX_CTRL_CTL_USE_AGC_BBA_ROUT                                 (Bit14)
#define RFTRX_REG_TRX_PLL_TRIG_MUX_CTRL_CTL_USE_AGC_BBA_2P4_INOUT                            (Bit15)
...
#define RFTRX_REG_PA_GAIN_RAMP_TH                                                            (RFTRX_REG_BASE + 0x220)
#define RFTRX_REG_PA_GAIN_RAMP_TH_DEFAULT                                                    0xFFFFFF
#define RFTRX_REG_PA_GAIN_RAMP_TH_CTL_TX_2P4_PA_GAIN_TH_0                                    (Bit0+Bit1+Bit2+Bit3+Bit4+Bit5+Bit6+Bit7)
#define RFTRX_REG_PA_GAIN_RAMP_TH_CTL_TX_2P4_PA_GAIN_TH_0_MASK                               (Bit7+Bit6+Bit5+Bit4+Bit3+Bit2+Bit1+Bit0)
#define RFTRX_REG_PA_GAIN_RAMP_TH_CTL_TX_2P4_PA_GAIN_TH_0_SHIFT                              (0)
#define RFTRX_REG_PA_GAIN_RAMP_TH_CTL_TX_2P4_PA_GAIN_TH_1                                    (Bit8+Bit9+Bit10+Bit11+Bit12+Bit13+Bit14+Bit15)
#define RFTRX_REG_PA_GAIN_RAMP_TH_CTL_TX_2P4_PA_GAIN_TH_1_MASK                               (Bit7+Bit6+Bit5+Bit4+Bit3+Bit2+Bit1+Bit0)
#define RFTRX_REG_PA_GAIN_RAMP_TH_CTL_TX_2P4_PA_GAIN_TH_1_SHIFT                              (8)
#define RFTRX_REG_PA_GAIN_RAMP_TH_CTL_TX_2P4_PA_GAIN_TH_2                                    (Bit16+Bit17+Bit18+Bit19+Bit20+Bit21+Bit22+Bit23)
#define RFTRX_REG_PA_GAIN_RAMP_TH_CTL_TX_2P4_PA_GAIN_TH_2_MASK                               (Bit7+Bit6+Bit5+Bit4+Bit3+Bit2+Bit1+Bit0)
#define RFTRX_REG_PA_GAIN_RAMP_TH_CTL_TX_2P4_PA_GAIN_TH_2_SHIFT                              (16)
#define RFTRX_REG_PA_GAIN_RAMP_TH_CTL_TX_2P4_PA_FORCE_EN                                     (Bit24)


#define RFTRX_REG_PA_GAIN_RAMP_STEP                                                          (RFTRX_REG_BASE + 0x228)
#define RFTRX_REG_PA_GAIN_RAMP_STEP_DEFAULT                                                  0x1010101
#define RFTRX_REG_PA_GAIN_RAMP_STEP_CTL_TX_2P4_PA_GAIN_STEP_0                                (Bit0+Bit1+Bit2+Bit3+Bit4+Bit5+Bit6+Bit7)
#define RFTRX_REG_PA_GAIN_RAMP_STEP_CTL_TX_2P4_PA_GAIN_STEP_0_MASK                           (Bit7+Bit6+Bit5+Bit4+Bit3+Bit2+Bit1+Bit0)
#define RFTRX_REG_PA_GAIN_RAMP_STEP_CTL_TX_2P4_PA_GAIN_STEP_0_SHIFT                          (0)
#define RFTRX_REG_PA_GAIN_RAMP_STEP_CTL_TX_2P4_PA_GAIN_STEP_1                                (Bit8+Bit9+Bit10+Bit11+Bit12+Bit13+Bit14+Bit15)
#define RFTRX_REG_PA_GAIN_RAMP_STEP_CTL_TX_2P4_PA_GAIN_STEP_1_MASK                           (Bit7+Bit6+Bit5+Bit4+Bit3+Bit2+Bit1+Bit0)
#define RFTRX_REG_PA_GAIN_RAMP_STEP_CTL_TX_2P4_PA_GAIN_STEP_1_SHIFT                          (8)
#define RFTRX_REG_PA_GAIN_RAMP_STEP_CTL_TX_2P4_PA_GAIN_STEP_2                                (Bit16+Bit17+Bit18+Bit19+Bit20+Bit21+Bit22+Bit23)
#define RFTRX_REG_PA_GAIN_RAMP_STEP_CTL_TX_2P4_PA_GAIN_STEP_2_MASK                           (Bit7+Bit6+Bit5+Bit4+Bit3+Bit2+Bit1+Bit0)
#define RFTRX_REG_PA_GAIN_RAMP_STEP_CTL_TX_2P4_PA_GAIN_STEP_2_SHIFT                          (16)
#define RFTRX_REG_PA_GAIN_RAMP_STEP_CTL_TX_2P4_PA_GAIN_STEP_3                                (Bit24+Bit25+Bit26+Bit27+Bit28+Bit29+Bit30+Bit31)
#define RFTRX_REG_PA_GAIN_RAMP_STEP_CTL_TX_2P4_PA_GAIN_STEP_3_MASK                           (Bit7+Bit6+Bit5+Bit4+Bit3+Bit2+Bit1+Bit0)
#define RFTRX_REG_PA_GAIN_RAMP_STEP_CTL_TX_2P4_PA_GAIN_STEP_3_SHIFT                          (24)


#define RFTRX_REG_PA_GAIN_RAMP_STS                                                           (RFTRX_REG_BASE + 0x22c)
#define RFTRX_REG_PA_GAIN_RAMP_STS_DEFAULT                                                   0x0
#define RFTRX_REG_PA_GAIN_RAMP_STS_STS_TX_2P4_PA_GAIN_ST                                     (Bit0+Bit1+Bit2+Bit3)
#define RFTRX_REG_PA_GAIN_RAMP_STS_STS_TX_2P4_PA_GAIN_ST_MASK                                (Bit3+Bit2+Bit1+Bit0)
#define RFTRX_REG_PA_GAIN_RAMP_STS_STS_TX_2P4_PA_GAIN_ST_SHIFT                               (0)
#define RFTRX_REG_PA_GAIN_RAMP_STS_STS_TX_2P4_CURR_PA_GAIN                                   (Bit8+Bit9+Bit10+Bit11+Bit12+Bit13+Bit14+Bit15)
#define RFTRX_REG_PA_GAIN_RAMP_STS_STS_TX_2P4_CURR_PA_GAIN_MASK                              (Bit7+Bit6+Bit5+Bit4+Bit3+Bit2+Bit1+Bit0)
#define RFTRX_REG_PA_GAIN_RAMP_STS_STS_TX_2P4_CURR_PA_GAIN_SHIFT                             (8)
#define RFTRX_REG_PA_GAIN_RAMP_STS_STS_TX_2P4_PA_GAIN_TGT                                    (Bit16+Bit17+Bit18+Bit19+Bit20+Bit21+Bit22+Bit23)
#define RFTRX_REG_PA_GAIN_RAMP_STS_STS_TX_2P4_PA_GAIN_TGT_MASK                               (Bit7+Bit6+Bit5+Bit4+Bit3+Bit2+Bit1+Bit0)
#define RFTRX_REG_PA_GAIN_RAMP_STS_STS_TX_2P4_PA_GAIN_TGT_SHIFT                              (16)
#define RFTRX_REG_PA_GAIN_RAMP_STS_STS_TX_2P4_PA_EN                                          (Bit24)
#define RFTRX_REG_PA_GAIN_RAMP_STS_STS_TX_2P4_PA2_EN                                         (Bit25)


#define RFTRX_REG_PA_MASK_CTRL                                                               (RFTRX_REG_BASE + 0x240)
#define RFTRX_REG_PA_MASK_CTRL_DEFAULT                                                       0x13271000
#define RFTRX_REG_PA_MASK_CTRL_CTL_TX_PA_MASK_EN                                             (Bit0)
#define RFTRX_REG_PA_MASK_CTRL_CTL_TX_PA_MASK_WITH_RAMP                                      (Bit1)
#define RFTRX_REG_PA_MASK_CTRL_CTL_TX_PA2_EN                                                 (Bit2)
#define RFTRX_REG_PA_MASK_CTRL_CTL_TX_PA_MASK_NUM_BIT                                        (Bit8+Bit9+Bit10+Bit11+Bit12+Bit13+Bit14+Bit15)
#define RFTRX_REG_PA_MASK_CTRL_CTL_TX_PA_MASK_NUM_BIT_MASK                                   (Bit7+Bit6+Bit5+Bit4+Bit3+Bit2+Bit1+Bit0)
#define RFTRX_REG_PA_MASK_CTRL_CTL_TX_PA_MASK_NUM_BIT_SHIFT                                  (8)
#define RFTRX_REG_PA_MASK_CTRL_CTL_TX_PA_MASK_BIT0_INT_LMT                                   (Bit16+Bit17+Bit18+Bit19+Bit20+Bit21+Bit22+Bit23)
#define RFTRX_REG_PA_MASK_CTRL_CTL_TX_PA_MASK_BIT0_INT_LMT_MASK                              (Bit7+Bit6+Bit5+Bit4+Bit3+Bit2+Bit1+Bit0)
#define RFTRX_REG_PA_MASK_CTRL_CTL_TX_PA_MASK_BIT0_INT_LMT_SHIFT                             (16)
#define RFTRX_REG_PA_MASK_CTRL_CTL_TX_PA_MASK_INT_LMT                                        (Bit24+Bit25+Bit26+Bit27+Bit28+Bit29+Bit30+Bit31)
#define RFTRX_REG_PA_MASK_CTRL_CTL_TX_PA_MASK_INT_LMT_MASK                                   (Bit7+Bit6+Bit5+Bit4+Bit3+Bit2+Bit1+Bit0)
#define RFTRX_REG_PA_MASK_CTRL_CTL_TX_PA_MASK_INT_LMT_SHIFT                                  (24)
