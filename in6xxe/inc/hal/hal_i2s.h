...
#define MI2S_CH0_BASE		(I2S_MASTER_BASE + I2S_CH0_BASE_OFS)
#define MI2S_CH1_BASE		(I2S_MASTER_BASE + I2S_CH1_BASE_OFS)

#define SI2S_CH0_BASE		(I2S_SLAVE_BASE + I2S_CH0_BASE_OFS)
#define SI2S_CH1_BASE		(I2S_SLAVE_BASE + I2S_CH1_BASE_OFS)
...
static __inline void i2s_sd_oe(int id, int ch_id, int oe)
{
	...
	if (id == MI2S_ID) {
		if (ch_id == I2S_CH_1) {
			if (oe) {
				reg &= ~GLOBAL_REG_I2S_OEN_CTRL_CTL_I2S_MASTER_PIN0_OEN;
			} else {
				reg |= GLOBAL_REG_I2S_OEN_CTRL_CTL_I2S_MASTER_PIN0_OEN;
			}
		} else {
			if (oe) {
				reg &= ~GLOBAL_REG_I2S_OEN_CTRL_CTL_I2S_MASTER_PIN1_OEN;
			} else {
				reg |= GLOBAL_REG_I2S_OEN_CTRL_CTL_I2S_MASTER_PIN1_OEN;
			}
		}
		...
		if (ch_id == I2S_CH_1) {
			...
			if (oe) {
				reg &= ~GLOBAL_REG_I2S_OEN_CTRL_CTL_I2S_SLAVE_SD_BKUP_OEN;
			} else {
				reg |= GLOBAL_REG_I2S_OEN_CTRL_CTL_I2S_SLAVE_SD_BKUP_OEN;
			}
		}
